...
function BecomeATutor() {
  ...
  const [sessionerror, setSessionError] = useState<
    Partial<Data> & { [key: string]: string }
  >({});
  const handleInputData = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (Object.keys(errors).length === 0) {
      axios
        .post("http://localhost:3001/api/tutor-registration", sessionData)
        .then(() => {
          ...
          >
            ...
            <div className="block">
              ...
              <p className="formt-sm">
                Please fill out the form below, submit it, and we will get back
